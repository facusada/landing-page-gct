...
<template>
  <footer class="bg-core-ink text-white">
    <div class="section-shell grid gap-10 py-16 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div>
        ...
        <address class="mt-4 grid gap-3 not-italic text-sm text-white/50">
          ...
          <a
            class="group flex items-center gap-3 transition hover:text-white"
            :href="siteConfig.whatsapp"
            target="_blank"
            rel="noopener noreferrer"
            :aria-label="`${t('footer.whatsappHint')}: ${siteConfig.phone}`"
          >
            <svg class="h-4 w-4 shrink-0 text-core-orange" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><path d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.9 7.9 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.9 7.9 0 0 0 13.6 2.326zM7.994 14.521a6.6 6.6 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.56 6.56 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592zm3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.588-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.73.73 0 0 0-.529.247c-.182.198-.691.677-.691 1.654 0 .977.71 1.916.81 2.049.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.337-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232z" /></svg>
            {{ siteConfig.phone }}
          </a>
          <a
            class="group flex items-start gap-3 transition hover:text-white"
            :href="mapsUrl"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <div class="mt-5 flex gap-3">
          ...
          <a :href="siteConfig.social.facebook" class="text-white/40 transition hover:text-white" aria-label="Facebook">
            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
          </a>
          <a :href="siteConfig.social.instagram" class="text-white/40 transition hover:text-white" aria-label="Instagram">
