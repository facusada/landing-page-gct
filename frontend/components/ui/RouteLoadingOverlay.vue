...
<template>
  <div class="fixed inset-0 z-[80] flex items-center justify-center bg-core-ink" role="status" aria-live="polite">
    ...
    <svg class="orbit-mark h-20 w-20 md:h-24 md:w-24" viewBox="0 0 64 64" fill="none" aria-hidden="true">
      ...
      <path d="M44 14C52 21 47 39 35 48C24 56 12 53 10 43C8 34 17 19 29 13C35 10 40 11 44 14Z" stroke="#606AF4" stroke-opacity="0.16" stroke-width="5" />
      ...
      <path class="trace trace-blue" d="M44 14C52 21 47 39 35 48C24 56 12 53 10 43C8 34 17 19 29 13C35 10 40 11 44 14Z" pathLength="100" stroke="#606AF4" stroke-width="5" stroke-linecap="round" />
...
<style scoped>
.orbit-mark {
  filter: drop-shadow(0 0 24px rgba(96, 106, 244, 0.35)) drop-shadow(0 0 48px rgba(241, 125, 48, 0.18));
}
.trace {
