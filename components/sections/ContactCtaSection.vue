...
<template>
  <section class="relative isolate overflow-hidden bg-core-navy py-20 text-white md:py-28">
    <img
    ...
    <div v-reveal class="section-shell max-w-4xl text-center">
      ...
      <p class="mx-auto mt-5 max-w-2xl text-xl leading-8 text-white/78">
        Revisemos migracion, seguridad y operacion con un enfoque que reduzca riesgos y habilite una evolucion sostenible.
      </p>
      <div class="mt-8">
